...
static const _TelloAction_Event_type_support_symbol_names_t _TelloAction_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tello_msgs, srv, TelloAction_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tello_msgs, srv, TelloAction_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tello_msgs, srv, TelloAction_Event)() {
  return &::tello_msgs::srv::rosidl_typesupport_c::TelloAction_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t TelloAction_service_type_support_handle = {
  ...
  &TelloAction_Request_message_type_support_handle,
  &TelloAction_Response_message_type_support_handle,
  &TelloAction_Event_message_type_support_handle,
