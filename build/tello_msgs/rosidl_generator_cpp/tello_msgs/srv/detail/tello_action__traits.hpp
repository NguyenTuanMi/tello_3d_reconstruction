...
inline std::string to_yaml(const TelloAction_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use tello_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const tello_msgs::srv::TelloAction_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  tello_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use tello_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const tello_msgs::srv::TelloAction_Event & msg)
{
  return tello_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<tello_msgs::srv::TelloAction_Event>()
{
  return "tello_msgs::srv::TelloAction_Event";
}

template<>
inline const char * name<tello_msgs::srv::TelloAction_Event>()
{
  return "tello_msgs/srv/TelloAction_Event";
}

template<>
struct has_fixed_size<tello_msgs::srv::TelloAction_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<tello_msgs::srv::TelloAction_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<tello_msgs::srv::TelloAction_Request>::value && has_bounded_size<tello_msgs::srv::TelloAction_Response>::value> {};

template<>
struct is_message<tello_msgs::srv::TelloAction_Event>
  : std::true_type {};
