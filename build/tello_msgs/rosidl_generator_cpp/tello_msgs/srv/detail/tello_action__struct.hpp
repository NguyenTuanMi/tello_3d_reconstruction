...
#ifndef _WIN32
# define DEPRECATED__tello_msgs__srv__TelloAction_Event __attribute__((deprecated))
#else
# define DEPRECATED__tello_msgs__srv__TelloAction_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct TelloAction_Event_
{
  using Type = TelloAction_Event_<ContainerAllocator>;

  explicit TelloAction_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit TelloAction_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<tello_msgs::srv::TelloAction_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tello_msgs::srv::TelloAction_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<tello_msgs::srv::TelloAction_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tello_msgs::srv::TelloAction_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<tello_msgs::srv::TelloAction_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tello_msgs::srv::TelloAction_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<tello_msgs::srv::TelloAction_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tello_msgs::srv::TelloAction_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    tello_msgs::srv::TelloAction_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const tello_msgs::srv::TelloAction_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<tello_msgs::srv::TelloAction_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<tello_msgs::srv::TelloAction_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      tello_msgs::srv::TelloAction_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<tello_msgs::srv::TelloAction_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      tello_msgs::srv::TelloAction_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<tello_msgs::srv::TelloAction_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<tello_msgs::srv::TelloAction_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<tello_msgs::srv::TelloAction_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__tello_msgs__srv__TelloAction_Event
    std::shared_ptr<tello_msgs::srv::TelloAction_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__tello_msgs__srv__TelloAction_Event
    std::shared_ptr<tello_msgs::srv::TelloAction_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const TelloAction_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using TelloAction_Event =
  tello_msgs::srv::TelloAction_Event_<std::allocator<void>>;
...
struct TelloAction
{
  ...
  using Event = tello_msgs::srv::TelloAction_Event;
};
